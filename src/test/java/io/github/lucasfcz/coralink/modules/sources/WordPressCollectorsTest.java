...
class WordPressCollectorsTest {
    ...
    void testCesarCollectorConfig() {
        ...
        assertEquals("CESAR", collector.sourceName());
    ...
    void testCesarSchoolCollectorConfig() {
        ...
        assertEquals("CESAR_SCHOOL", collector.sourceName());
    ...
    void testCinUfpeCollectorConfig() {
        ...
        assertEquals("CIN_UFPE", collector.sourceName());
    ...
    void testIfpeCollectorConfig() {
        ...
        assertEquals("IFPE", collector.sourceName());
    ...
    void testUnifafireCollectorConfig() {
        ...
        assertEquals("UNIFAFIRE", collector.sourceName());
    ...
    void testUpeCollectorConfig() {
        ...
        assertEquals("UPE", collector.sourceName());
    ...
    void testSenacPeCollectorConfig() {
        ...
        assertEquals("SENAC_PE", collector.sourceName());
